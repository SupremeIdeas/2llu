...
/**
 * ISO-3166 alpha-2 → international dialling code, for the shared CountryPicker's
 * phone-number mode (Numbers V6). Accepts the same slugs/codes as CountryFlags
 * (resolves the slug to ISO2 first). Unknown → null, and the picker simply omits
 * the dial code rather than showing a wrong one.
 */
class DialCodes
{
