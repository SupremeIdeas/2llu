...
<div {{ $attributes->merge(['class' => 'flex items-center gap-2']) }}>
    <div class="relative flex-1">
        ...
        <input type="text" x-model="{{ $searchVar }}" placeholder="{{ $placeholder }}"
               class="w-full rounded-xl border border-slate-300 bg-white py-2.5 pl-9 pr-3 text-sm text-slate-900 placeholder-slate-400 focus:border-primary focus:ring-2 focus:ring-primary/40 dark:border-[#2D4060] dark:bg-[#243352] dark:text-slate-100">
    </div>

    <div class="flex shrink-0 items-center gap-1 rounded-xl border border-slate-200 bg-slate-100 p-1 dark:border-[#2D4060] dark:bg-[#1A2840]">
