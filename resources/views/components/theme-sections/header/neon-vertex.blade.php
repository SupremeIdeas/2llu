...
<header class="sticky top-2 z-30 mx-3 flex items-center justify-between rounded-full border border-accent/25 bg-white/90 px-4 py-2.5 shadow-[0_8px_30px_rgba(0,0,0,0.08)] backdrop-blur lg:hidden dark:border-accent/30 dark:bg-navy/90 dark:shadow-[0_8px_30px_rgba(0,0,0,0.4)]">
