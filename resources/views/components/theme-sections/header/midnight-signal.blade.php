...
<header class="sticky top-0 z-30 flex items-center justify-between border-b border-primary/20 bg-white/90 px-4 py-3 backdrop-blur lg:hidden dark:border-primary/25 dark:bg-navy/90">
