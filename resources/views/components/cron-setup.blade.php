...
<div class="rounded-2xl border border-slate-200 bg-white p-5 text-left dark:border-[#2D4060] dark:bg-[#1A2840]">
    ...
    <div x-data="{ copied: false, cmd: @js($cronLine) }" class="mt-4">
        ...
        <div class="flex items-stretch gap-2">
            <code class="flex-1 overflow-x-auto rounded-lg border border-slate-200 bg-slate-50 px-3 py-2.5 font-mono text-xs text-slate-700 dark:border-[#2D4060] dark:bg-[#243352] dark:text-slate-200">{{ $cronLine }}</code>
            <button type="button"
